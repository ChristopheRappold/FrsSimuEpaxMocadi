...
public :
  ...
  tuple_graph()
  {}
  tuple_graph(const std::string& Name, const std::vector<int>& ids, double TCm, double TgCM, double prodF, double prodP1, double prodP2, double prodP3,const std::vector<double>& stage):
    BT(Name),BT_ids(ids),TargetCm(1,TCm),TargetGramCm(1,TgCM),ProdFrag(1,prodF),ProdPara1(1,prodP1),ProdPara2(1,prodP2),ProdPara3(1,prodP3),ProdStage(1,stage)
  {}
  tuple_graph(const std::string& Name, const std::vector<int>& ids, double TCm, double TgCM, double prodF, double prodP1, double prodP2, double prodP3):
    BT(Name),BT_ids(ids),TargetCm(1,TCm),TargetGramCm(1,TgCM),ProdFrag(1,prodF),ProdPara1(1,prodP1),ProdPara2(1,prodP2),ProdPara3(1,prodP3)
  {}
  ~tuple_graph() {}
  tuple_graph(const tuple_graph& t):BT(t.BT),BT_ids(t.BT_ids),TargetCm(t.TargetCm),TargetGramCm(t.TargetGramCm),ProdFrag(t.ProdFrag),ProdPara1(t.ProdPara1),ProdPara2(t.ProdPara1),ProdPara3(t.ProdPara3),ProdStage(t.ProdStage)
  {}
  ...
  void AddValue(double TCm, double TgCM, double prodF, double prodP1, double prodP2, double prodP3)
  {
    TargetCm.push_back(TCm);
    TargetGramCm.push_back(TgCM);
    ProdFrag.push_back(prodF);
...
void Analysis(std::string namefile, int type = 0, std::string ICtype = "I-C", std::string Mtype = "A B AB", int Ntype = -1, int NtypeComp = 1, double minHist = 0)
{
